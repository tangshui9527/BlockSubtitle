...
1. **Floating window not appearing**: Ensure the "Draw over other apps" permission is granted in system settings
2. **App crashes on launch**: Check that your device meets the minimum Android version requirement (Android 6.0+)
3. **Window position not saved**: Make sure the app isn't being force stopped by the system
...
- The floating window may be hidden behind some system dialogs or overlays with higher priority
- On some devices, battery optimization settings may affect the foreground service
- Window size has a minimum limit of 50 pixels in both dimensions

## Future Improvements

- Add customization options for window color and transparency
- Implement multiple window support
- Add quick toggle from notification
